...
Page({
	...
	GoBackMiniProgram: function (wxappid,path,phone,signature,wxopenid,wxunionid,timestamp,province,nickname,avatarUrl,gender,city,country){
	...
	UnionWXUserLogin: function () {
		...
		request.postRequest("/User/UnionWXUserLogin", data1, function (res) {
          ...
          console.log("wxappid1", wxappid);
					if (wxappid!='' && wxpath !="")
					{
							_this.GoBackMiniProgram(wxappid,wxpath,wxphone,wxsignature,wxopenid,wxunionid,wxtimestamp,wxprovince,wxnickname,wxavatarUrl,wxgender,wxcity,wxcountry);
					}
			 }
		});
	},
