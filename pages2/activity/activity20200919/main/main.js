...
Page({
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			app.appIsOnloadCallback = () => {
				...
				request.postRequest("/Product/ProductIsBuy",
				{
					"sCode":"003"
				},
				function(res) {
					if (res.StatusCode == 200 && res.Data!="") {
						wx.redirectTo({
							url:  '/pages2/activity/activity20200919/paydetail/detail?pcode=' +res.Data,
						});
					}
				})
	...
	onShareAppMessage: function () {
		var _this=this;
		return {
			title: "买家至上  919年度新品就要购",
		//	path: 'pages2/activity/activity20200919/main/main',
