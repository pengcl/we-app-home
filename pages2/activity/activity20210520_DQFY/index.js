...
Page({
  ...
  data: {
    vPhoneNum :'',
    hasPhoneNum: false,
    mainImg:  vdomain +'image/activity/activity20210520_DQFY/01.jpg',
    shareImg: vdomain +'image/activity/activity20210520_DQFY/01.jpg',
    //detailList: [
      //{
      //  id: 2,
      //  img: vdomain + "image/activity/activity20210520_DQFY/01.jpg"
      //}
      //,{
      //  id: 3,
      //  img: vdomain + "image/activity/activity20210520_DQFY/03.jpg"
      //}
      //,{
      //  id: 4,
      //  img: vdomain + "image/activity/activity20210520_DQFY/04.jpg"
      //}
    //]
  ...
  redir_tap: function (e) {
	...
	AddUserWXLogin: function () {
		var ProjectGID = "F5A0ACB0-6914-4B3C-B53B-82BD33627788";//this.data.ProjectCommunity_Gid;
