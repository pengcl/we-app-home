...
Page({
  data: {
    ...
    gwID: '',
    image1: vdomain + 'image/activity/activity_lnwyy/tj_1.jpg',
    image2: vdomain + 'image/activity/activity_lnwyy/tj_2.jpg',
    button: vdomain + 'image/activity/activity_lnwyy/button2.png'
  },
  ...
  book_tap: function () {
    ...
    if (oc == "" || typeof (oc) == "undefined" || vName == "" || vPhone == "" || vPjid == "" || vPjName == "") {
      ...
      request.postRequest("/Order/OrderHDAddWYY",
        data,
        function (res) {
          wx.hideLoading();
          if (res.StatusCode == 200) {
            ...
            wx.showToast({
              ...
              success: function () {
                setTimeout(function () {
                  wx.redirectTo({
                    url: 'tjaward?orderCode=' + that.data.ordercode,
                  })
                }, 2000)
              }
            })
