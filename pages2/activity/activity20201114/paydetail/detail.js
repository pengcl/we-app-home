...
Page({
  ...
  onLoad: function (options) {
    ...
    let projName = "";
    let iszl = 0;
    if (productCode=="004-yy")
    {
      activCode = "AT20004";
      projName = "YY";
      iszl = 1;
    }
    if (productCode=="004-zc")
    {
      activCode = "AT20007";
      projName = "ZC";
    }
    if (productCode=="004-gf")
    {
      activCode = "AT20005";
      projName = "GF";
      iszl = 1;
    }
    if (productCode=="004-kyw")
    {
      activCode = "AT20006";
      projName="KYW";
      iszl = 0;
    }
    if (productCode=="004-qy")
    {
      activCode = "AT20008";
      projName = "QY";
      iszl = 1;
    }
    if (productCode=="004-zq")
    {
      activCode = "AT20009";
      projName = "ZQ";
    }
    ...
    request.getRequest("/Order/OrderHexiao_QXHN",
      data,
      function (res) {
