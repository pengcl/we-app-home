...
Page({
  ...
  hideAdModal: function (e) {
    ...
    if (awardgid.toUpperCase() !="AB111121-9999-9999-9999-999999999999")
    {
		this.setData({
			adModalShow: true,
		});
  ...
  HX_tap: function (e) {
    ...
    console.log("aaaaa");
    request.postRequest("/Lottery/LotteryRecordHX20201114",
      data1,
      function (res) {
  ...
  loadInfo: function (gid) {
    ...
    let comecode = wx.getStorageSync('comecode');
    console.log('comecode111',comecode);
    let data = {
      sLotteryID: gid,
      sProject: 'ZC',
      orderCode:'',
    ...
    request.getRequest("/Lottery/LotteryRecord20201114",
      data,
      function (res) {
