...
Page({
  ...
  onLoad: function (options) {
    let that = this
    let vlotterygid = "AB222222-2222-0000-0000-000000000000"
    that.setData({
  ...
  hideAdModal: function (e) {
    ...
    if (awardgid.toUpperCase() !="ab222222-2222-9999-9999-999999999999")
    {
		this.setData({
			adModalShow: true,
		});
  ...
  loadInfo: function (gid) {
    ...
    console.log("orderCode111",that.data.orderCode);
