...
Page({
  ...
  onLoad: function (options) {
    let that = this
    let vlotterygid = "AB222222-4444-0000-0000-000000000000"
    that.setData({
  ...
  hideAdModal: function (e) {
    ...
    if (awardgid.toUpperCase() !="ab222222-4444-9999-9999-999999999999")
    {
		this.setData({
			adModalShow: true,
		});
  ...
  AddUserWXLogin: function () {
    var ProjectGID = 'F5A0ACB0-6914-4B3C-B53B-82BD33627788';
