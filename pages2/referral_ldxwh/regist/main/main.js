...
Page({
  ...
  bindUserTypeChange: function (e) {
    ...
    switch (index) {
      case "1":
        ...
        break;
      case "2":
        text = '*请上传/拍摄提交个人名片，方便我方进行审核。'
        break;
      case "3":
        text = '*如阁下为业主，请提供所购住宅信息。如：不动产权证或个人名下查册证明'
        break;
      //case "4":
      ...
      wx.chooseImage({
        ...
        success(res) {
          ...
          wx.uploadFile({
            ...
            name: 'file',
            formData: {
              'path': '/UploadFile/referral_LDXWH/',
              'name': 'referral',
              'thumbWidth': '697',
              'thumbHeight': '287'
            },
  ...
  submit_tap: function (e) {
    ...
    request.postRequest("/LDXWH/LDXEUserAdd",
      data,
      function (res) {
        if (res.StatusCode == 200) {
          wx.redirectTo({
