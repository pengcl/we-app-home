...
handleChangeScroll ({ detail }) {
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			...
			request.postRequest("/Saler/SalerList", data, function (res) {
				let _SalerList = [
					{
						id: 0,
						usercode: 0,
  ...
  LS1_tap: function (e) {
	...
	ok_tap:function(){
		wx.redirectTo({
			url: 'https://mp.weixin.qq.com/tp/ad_detail_info?page_key=d8d9a5a6e20ce1dd8d5cb8efa8a1a3e8c174d7fe184b793b8684c87df7e29ecf033f6fabcdd9e2a76fa4ae26dbee312b&uxinfo=3856206144%7Cwx0lbuehkhi43n4s%7C%7C0%7C1629456962%7C0%7C2%7C20141119%7C%7CAgLQmhvoJl%2BqHv20VP7yLSb8IgQydxLrRX9wO%2BZ2TVRvF1BXZDlBt0v2c5G0mtG12LzfEBC7yvE%3D%7C3856206153%7C21%7C0&version=63030532&ascene=1&lang=zh_CN&devicetype=Windows+7+x64&fontgear=2',
		})
	}
