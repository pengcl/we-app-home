...
handleChangeScroll ({ detail }) {
	...
	onPullDownRefresh: function () {
		//var _this = this;
		//let thiscurrent = _this.data.current;
		//if (thiscurrent=="t2")
		//{
		//	_this.setData(
		//		{
	...
	onPageScroll: function (e) {
		...
		//const queryt2 = wx.createSelectorQuery();
		//queryt2.select('#t2').boundingClientRect();
		////console.log("resAA", queryt1);
	  ////queryt1.selectViewport().scrollOffset();
    //queryt2.exec(function(res){
			  //console.log("resAA", res);
    		//res[0].top       // #t1节点的上边界坐标
				//res[1].scrollTop // 显示区域的竖直滚动位置
				//console.log("resAA", res[0].top);
				//console.log("resAA", res[1].scrollTop);
				//console.log("resAA", res[0].bottom);
				//console.log("resAA", res[0].height);
		//		if (res[0].top>100)
		//		{
		//			_this.setData({
		//				current:"t1"
		...
		//const queryt3 = wx.createSelectorQuery();
		//queryt3.select('#t3').boundingClientRect();
		////console.log("resAA", queryt1);
	  ////queryt1.selectViewport().scrollOffset();
    //queryt3.exec(function(res){
			  //console.log("resAA", res);
    		//res[0].top       // #t1节点的上边界坐标
				//res[1].scrollTop // 显示区域的竖直滚动位置
				//console.log("resAA", res[0].top);
  ...
  t2upper:function(e){
		console.log("t1lower:" + e.scrollTop);
		this.setData({
			current:"t1",
			current_scroll:"t1",
		});
