...
Page({
	...
	data: {
		...
		ProjectCommunity_Gid: "A14C2D8E-8C0D-4A45-A789-1E4376AD31F6",
		windowHeight: 0,
		// hasVR: true,
		currHuXingVR: "",
		scrollintoview: "",
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			...
			request.MainGetRequest("/Page/JH_index", {}, function (
				res
			) {
				console.log("res111222",res);
				_this.setData({
	...
	wechat_tap: function (e) {
		var ProjectGID = "A14C2D8E-8C0D-4A45-A789-1E4376AD31F6";
		wx.navigateTo({
			url:
