...
Page({
	...
	data: {
		...
		ProjectCommunity_Gid: "B2CE091E-932F-4208-A1EC-364912841561",
		windowHeight: 0,
		// hasVR: true,
		currHuXingVR: "",
		scrollintoview: "",
 ...
 click3: function () {
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			...
			request.MainGetRequest("/Page/SY4_index", {}, function (
				res
			) {
				console.log("SY4_index", res);
				_this.setData({
	...
	GetTT:function()
	{
		  let _this = this;
			request.getRequest(
				"/Toutiao/list",
				{"ProjectGID":"B2CE091E-932F-4208-A1EC-364912841561"},
				function (res) {
  ...
  LS1_tap: function (e) {
	...
	onShareAppMessage: function () {
		...
		return {
			...
			path: '/pages2/community/SY4/index/index',    
		};


	// 	var data ={
	// 		page_url:"pages2/community/NB/index/index",
	// 		page_name:"宁波新世界"
	// 	};
	...
	// 		title: "悦景新世界",
	// 		imageUrl: _this.data.pageData.ShareImg,
	// 		path: '/pages2/community/SY/index/index?sharecode=' + sharecode,    
	// 	};
	},
	...
	map_tap: function (e) {
		var lat = 41.11362,
			lng = 123.073324,
			vname = "鞍山新世界花园",
			vaddress = "辽宁省鞍山市立山区科技路与临清街交叉口西北方向190米";
		wx.openLocation({
			type: "gcj02",
			latitude: lat,
			longitude: lng,
