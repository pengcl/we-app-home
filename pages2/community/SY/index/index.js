...
Page({
	...
	data: {
		...
		ProjectCommunity_Gid: "B2CE091E-932F-4208-A1EC-817C19727403",
		windowHeight: 0,
		// hasVR: true,
		currHuXingVR: "",
		scrollintoview: "",
 ...
 click3: function () {
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			...
			request.MainGetRequest("/Page/SY_index", {}, function (
				res
			) {
				console.log("SY_index", res);
				_this.setData({
	...
	GetTT:function()
	{
		  let _this = this;
			request.getRequest(
				"/Toutiao/list",
				{"ProjectGID":"B2CE091E-932F-4208-A1EC-817C19727403"},
				function (res) {
  ...
  LS1_tap: function (e) {
	...
	onShareAppMessage: function () {
		...
		return {
			...
			path: '/pages2/community/SY/index/index',    
		};
