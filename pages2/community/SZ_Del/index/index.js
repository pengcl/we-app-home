...
Page({
  ...
  onLoad: function (options) {
    let that = this
    that.setData({
      bgImg: vdomain + 'image/sz/sz_1_1.jpg?v=20200821',
      icon: vdomain + 'image/sz/icon1.png',
      icon1: vdomain + 'image/sz/icon2.png',
  ...
  onShow: function () {
    let that = this
    that.setData({
      bgImg: vdomain + 'image/sz/sz_1_1.jpg?v=20200813',
      icon: vdomain + 'image/sz/icon1.png',
      icon1: vdomain + 'image/sz/icon2.png',
      phone: wx.getStorageSync('PhoneNum'),
      sexValue: '先生',
  ...
  saveSZUserInfo: function () {
    ...
    let data = {
      ...
      Project: 'F8C76F96-362D-2D73-AD23-33A9798C2785'
    }
