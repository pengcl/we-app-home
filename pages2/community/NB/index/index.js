...
Page({
	...
	data: {
		...
		ProjectCommunity_Gid: "0F39E154-CDE8-4177-AE93-26AA74B17E3F",
		windowHeight: 0,
		// hasVR: true,
		currHuXingVR: "",
		scrollintoview: "",
 ...
 click3: function () {
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			...
			request.MainGetRequest("/Page/NB_index", {}, function (
				res
			) {
				console.log("NB_index", res);
				_this.setData({
	...
	GetTT:function()
	{
		  let _this = this;
			request.getRequest(
				"/Toutiao/list",
				{"ProjectGID":"0F39E154-CDE8-4177-AE93-26AA74B17E3F"},
				function (res) {
  ...
  LS1_tap: function (e) {
	...
	onShareAppMessage: function () {
		...
		return {
			...
			path: '/pages2/community/NB/index/index'   
		};
	...
	map_tap: function (e) {
		var lat = 29.866787,
			lng = 121.563918,
			vname = "宁波新世界",
			vaddress = "浙江省宁波市鄞州区百丈路110西北方向90米";
		wx.openLocation({
			type: "gcj02",
			latitude: lat,
			longitude: lng,
