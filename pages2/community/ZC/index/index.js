 ...
 click3: function () {
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			...
			request.MainGetRequest("/Page/ZC_index", {}, function (
				res
			) {
				console.log("ZC_index", res);
				_this.setData({
  ...
  LS1_tap: function (e) {
	...
	onShareAppMessage: function () {
		...
		var data ={
			page_url:"pages2/community/ZC/index/index",
			page_name:"广汇楼书"
		};
	 ...
	 var sharecode = _this.data.sharecode;
		...
		return {
			...
			path: '/pages2/community/ZC/index/index?sharecode=' + sharecode,    
		};
	},
