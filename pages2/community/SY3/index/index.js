...
Page({
	...
	data: {
		...
		ProjectCommunity_Gid: "B2CE091E-932F-4208-A1EC-364912973217",
		windowHeight: 0,
		// hasVR: true,
		currHuXingVR: "",
		scrollintoview: "",
 ...
 click3: function () {
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			...
			request.MainGetRequest("/Page/SY3_index", {}, function (
				res
			) {
				console.log("SY3_index", res);
				_this.setData({
	...
	GetTT:function()
	{
		  let _this = this;
			request.getRequest(
				"/Toutiao/list",
				{"ProjectGID":"B2CE091E-932F-4208-A1EC-364912973217"},
				function (res) {
  ...
  LS1_tap: function (e) {
	...
	map_tap: function (e) {
		var lat = 38.923709,
			lng = 121.653049,
			vname = "新世界·名泷",
			vaddress = "辽宁省大连市中山区人民路街道人民路41号(新世界大厦东塔楼)";
		wx.openLocation({
			type: "gcj02",
			latitude: lat,
			longitude: lng,
