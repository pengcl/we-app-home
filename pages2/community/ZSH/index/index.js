...
Page({
	...
	data: {
		...
		ProjectCommunity_Gid: "36C27989-762F-3308-A155-963719775201",
		windowHeight: 0,
		// hasVR: true,
		currHuXingVR: "",
		scrollintoview: "",
 ...
 click3: function () {
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			...
			request.MainGetRequest("/Page/ZSH_index", {}, function (
				res
			) {
				console.log("ZSH_index", res);
				_this.setData({
	...
	GetTT:function()
	{
		  let _this = this;
			request.getRequest(
				"/Toutiao/list",
				{"ProjectGID":"36C27989-762F-3308-A155-963719775201"},
				function (res) {
  ...
  LS1_tap: function (e) {
	...
	onShareAppMessage: function () {
		...
		return {
			...
			path: '/pages2/community/ZSH/index/index',    
		};
	},
