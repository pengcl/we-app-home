...
Page({
	...
	data: {
		...
		ProjectCommunity_Gid: "99998297-37AB-4EAE-9BB0-DEFEC35B5CA7",
		windowHeight: 0,
		// hasVR: true,
		currHuXingVR: "",
		scrollintoview: "",
 ...
 click3: function () {
		...
		if (app.globalData.appIsOnload == false) {
			app.appIsOnloadCallback = () => {
				request.MainGetRequest(
					...
					{},
					function (res) {
						console.log("HangZhou_index", res);
						_this.setData({
							pageData: res.data,
						});
					}
			...
			request.MainGetRequest("/Page/HangZhou_index", {}, function (
				res
			) {
				console.log("HangZhou_index", res);
				_this.setData({
	...
	GetTT:function()
	{
		  let _this = this;
			request.getRequest(
				"/Toutiao/list",
				{"ProjectGID":"99998297-37AB-4EAE-9BB0-DEFEC35B5CA7"},
				function (res) {
  ...
  LS1_tap: function (e) {
	...
	onShareAppMessage: function () {
		...
		return {
			...
			path: '/pages2/community/HangZhou/index/index',    
		};
	},
