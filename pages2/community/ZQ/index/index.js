// pages2/community/ZQ/index/index.js
...
Page({
	...
	data: {
		...
		ProjectCommunity_Gid: "D8834E95-AE3B-4A92-B503-DDB73B0C74D8",
		windowHeight: 0,
		// hasVR: true,
		currHuXingVR: "",
		scrollintoview: "",
	...
	onLoad: function (options) {
		...
		if (app.globalData.appIsOnload == false) {
			...
			request.MainGetRequest("/Page/ZQ_index", {}, function (
				res
			) {
				_this.setData({
					pageData: res.data,
	...
	img_tap: function (e) {
		// console.log(e.currentTarget.dataset.code, e.currentTarget.dataset.code || "", (e.currentTarget.dataset.code || "") != "");
		// if ((e.currentTarget.dataset.code || "") != "") {
		//   wx.navigateTo({
		//     url: '../detail/detail?code=' + e.currentTarget.dataset.code
		//   })
		// }
	},
	goYuYue: function (e) {
	...
	wechat_tap: function (e) {
		var ProjectGID = this.data.ProjectCommunity_Gid; // "152E7F4B-55F0-4E2C-BBD3-684AF00CB499";
		wx.navigateTo({
			url:
